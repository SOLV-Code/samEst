...
#include "stanExports_ricker_linear.h"

RCPP_MODULE(stan_fit4ricker_linear_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_ricker_linear")
