...
#' data(harck)
#' ricker_HMM_TMB(data=harck)
ricker_HMM_TMB_a <- function(data, k_regime=2, alpha_limits=c(0,20), beta_upper=.1, sigma_upper=2, 
  silent = FALSE, control = TMBcontrol(), ini_param=NULL, tmb_map = list()) {
...
#' data(harck)
#' ricker_HMM_TMB(data=harck)
ricker_HMM_TMB_b <- function(data, k_regime=2, alpha_limits=c(0,20), beta_upper=.1, sigma_upper=2, 
  silent = FALSE, control = TMBcontrol(), ini_param=NULL, tmb_map = list()) {
